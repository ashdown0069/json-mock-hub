  ...
  return (
    <header className="h-16 px-8 flex items-center justify-between border-b border-border/50 backdrop-blur-sm sticky top-0 z-50">
      ...
      {/* <nav className="flex items-center gap-4">
        <Button variant="ghost" className="font-bold hidden sm:flex">{t('documentation')}</Button>
        <Button variant="ghost" className="font-bold hidden sm:flex">{t('pricing')}</Button>
      </nav> */}
    </header>
  );
}
